function boardDetail(input) {
	...
	.done(function(response) {
		...
		if(username == response.writer || role == "ADMIN") {
			html += 		"<li class='board_update'><a href=/updateForm.do?boardNo="+ data +"&pageNum=" + pageNum +"&amount=" + amount +"&keyword=" + keyword +">Update</a></li>&nbsp&nbsp";
			html += 		"<li class='board_delete'><a href=/delete.do?boardNo="+ data +"&pageNum=" + pageNum +"&amount=" + amount +"&keyword=" + keyword +">Delete</a></li>";
